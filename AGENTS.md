...
- До создания подзадачи классифицировать наблюдение: тот же наблюдаемый
  результат продолжает текущую подзадачу; новый отдельно принимаемый результат
  того же владельца получает новую подзадачу; другой владелец или договор
  предъявляется владельцу как предложение отдельной задачи; недостающее
  доказательство добавляется в текущую подзадачу без нового номера.
