...
test("builds the real orchestration and isolated layout Worker bundles", async () => {
  ...
  try {
    ...
    expect(orchestrationSource).toContain("new FixedLayoutWorkerClient")
    expect(orchestrationSource).not.toContain("AdaptiveLayoutWorkerClient")
    expect(orchestrationSource).not.toContain("layoutAdaptive")
    ...
    expect(layoutWorkerSource).toContain("runFixedLayoutWorkerRequest")
    expect(layoutWorkerSource).toContain('type: "layout-result"')
    expect(layoutWorkerSource).not.toContain("runAdaptiveLayoutWorkerRequest")
    expect(layoutWorkerSource).not.toContain("layoutAdaptive")
