 ...
 *
 * Используется при создании атома для определения структуры и типов данных контекста.
 ...
 * Atom("user")
 *   .context({
 *     name: t.string({title: "Имя пользователя", nullable: true}),
 ...
 * ```js
 * actions: {
 *   updateUser: async ({context, update}) => {
 ...
 *
 * Используется для создания полей с булевыми значениями в контексте атома.
 *
 ...
 *
 * Используется для создания числовых полей в контексте атома.
 *
 ...
 *
 * Используется для создания строковых полей в контексте атома.
 *
 ...
 *
 * Используется для создания полей-массивов в контексте атома.
 *
 ...
 *
 * Объединяет все возможные типы определений для полей контекста атома.
 ...
 *
 * Предоставляет методы для определения типов полей контекста атома.
 * Используется при создании атома через fluent API.
 *
 ...
 * ```js
 * const context = {
 *   name: t.string({title: "Имя"}),
 *   age: t.number({title: "Возраст"}),
 *   active: t.boolean({title: "Активен"}),
 *   tags: t.array({title: "Теги"}),
 *   role: t.enum({
 *     title: "Роль",
 *     values: ["user", "admin"]
 *  })
