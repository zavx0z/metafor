...
export const text = {
  ...
  voiceAgentReadyVolume: {ru: "Звук агента", en: "Agent sound"},
  voiceAgentReadyVolumeDown: {ru: "Тише", en: "Quieter"},
  voiceAgentReadyVolumeUp: {ru: "Громче", en: "Louder"},
  voiceSignalVolumeDown: {ru: "Тише", en: "Quieter"},
  voiceSignalVolumeUp: {ru: "Громче", en: "Louder"},
  voiceFuzzyTolerance: {ru: "Допуск Левенштейна", en: "Levenshtein tolerance"},
  voiceFuzzyToleranceDown: {ru: "Строже", en: "Stricter"},
  voiceFuzzyToleranceUp: {ru: "Мягче", en: "Looser"},
