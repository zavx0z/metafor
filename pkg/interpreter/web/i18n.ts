...
export const text = {
  ...
  displayAutoFocusActions: {ru: "Автопереход к display", en: "Auto-focus display"},
  displayAutoFocusActionsHint: {ru: "Фокусировать display, где выполняется действие", en: "Focus the display where an action runs"},
  displaySettings: {ru: "Настройки display", en: "Display settings"},
  ...
  voiceRecognitionTimeout: {ru: "Минимальная пауза", en: "Minimum pause"},
  voiceRecognitionMaxTimeout: {ru: "Максимальная пауза", en: "Maximum pause"},
