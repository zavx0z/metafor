...
6. Если несколько semantic edges имеют один и тот же exact port, совпадение в
...
8. Compaction не может удалить уже вычисленный занятый corridor между рядами
