import type { ValueDynamic, ValueVariable } from "@metafor/types/template/parser"
import type { PartsAttr, NodeType } from "@metafor/types/template/node/index"
import type { Attributes } from "@metafor/types/template/attribute/index"
import type { PartAttrMap, TokenMapClose, TokenMapOpen } from "@metafor/types/template/node/map"
import type { PartAttrCondition, TokenCondClose, TokenCondElse, TokenCondOpen } from "@metafor/types/template/node/condition"
import type { PartAttrMeta } from "@metafor/types/template/node/meta"
import type { PartAttrElement } from "@metafor/types/template/node/element"
import type { ParseContext, ParseResult } from "@metafor/types/template/parser"
import type { TokenText } from "@metafor/types/template/node/text"
import type { TokenLogicalOpen } from "@metafor/types/template/node/logical"
