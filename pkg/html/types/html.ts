 ...
 * тип, и он будет продолжать вести себя так же через следующую основную версию @quantum/html. Это может быть полезно для кода, который хочет подготовиться к следующей
 * основной версии @quantum/html.
 */
 ...
 * что шаблоны @quantum/html не скомпилированы. Когда работает с одним из них, используйте
...
/**
 * Объект, указывающий параметры для контроля рендеринга @quantum/html. Обратите внимание, что
