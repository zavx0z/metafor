 ...
 * @typedef {import('../types/html').TemplateResult} TemplateResult
...
class CacheDirective extends Directive {
  ...
  /** @param {import('../types/directives.ts').PartInfo} partInfo - Информация о части. */
  ...
  render(v) {
    // Возвращаем массив значения, чтобы побудить @quantum/html создать ChildPart
