...
class LiveDirective extends Directive {
  /** @param {import("../types/directives").PartInfo} partInfo - Информация о части */
   ...
   * @param {import("../types/directives").DirectiveParameters<this>} value - Значение
   * */
  update(part, [value]) {
 ...
 *
 * Это полезно для случаев, когда значение DOM может изменяться извне @quantum/html,
 ...
 * через привязки @quantum/html, не изменяется, @quantum/html не узнает о необходимости
