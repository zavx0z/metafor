...
class ClassMapDirective extends Directive {
  ...
  /** @param {import('../types/directives.ts').PartInfo} partInfo - Информация о части, к которой прикреплена директива. */
  ...
  /** @param {import('../types/directives.ts').ClassInfo} classInfo - Объект ClassInfo, содержащий имена классов и их значения. */
  render(classInfo) {
