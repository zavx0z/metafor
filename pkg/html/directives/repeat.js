...
class RepeatDirective extends Directive {
  ...
  /** @param {import("../types/directives").PartInfo} partInfo */
   ...
   * @param {import("../types/directives").KeyFn<T> | import("../types/directives").ItemTemplate<T>} keyFnOrTemplate
   * @param {import("../types/directives").ItemTemplate<T>} [template]
   ...
   * @param {[Iterable<T>, import("../types/directives").KeyFn<T> | import("../types/directives").ItemTemplate<T>, import("../types/directives").ItemTemplate<T>]} args
   */
  update(containerPart, [items, keyFnOrTemplate, template]) {
    ...
    // массив для обработки массивов @quantum/html для рендеринга и запоминаем
    // ключи.
