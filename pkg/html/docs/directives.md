...
Директивы — это функции, которые могут расширять QuantumAtom, настраивая способ отображения выражения. QuantumAtom включает ряд встроенных директив, помогающих с различными потребностями отображения:
...
> Объединяйте только то, что используете. Они называются «встроенными» директивами, поскольку являются частью пакета QuantumAtom. Но каждая директива — это отдельный модуль, поэтому ваше приложение объединяет только те
...
```js
import {classMap} from "@quantum/html/directives/class-map.js"
```
...
```js
import {styleMap} from "@quantum/html/directives/style-map.js"
```
...
```js
import {when} from "@quantum/html/directives/when.js"
```
...
```js
import {choose} from "@quantum/html/directives/choose.js"
```
...
```js
import {map} from "@quantum/html/directives/map.js"
```
...
```js
import {repeat} from "@quantum/html/directives/repeat.js"
```
...
```js
import {join} from "@quantum/html/directives/join.js"
```
...
```js
import {range} from "@quantum/html/directives/range.js"
```
...
```js
import {ifDefined} from "@quantum/html/directives/if-defined.js"
```
...
```js
import {LitElement, html} from "@quantum/html/index"
import {ifDefined} from "@quantum/html/directives/if-defined.js"
...
```js
import {cache} from "@quantum/html/directives/cache.js"
```
...
```js
import {keyed} from "@quantum/html/directives/keyed.js"
```
...
```javascript
import {LitElement, html} from "@quantum/html"
import {keyed} from "@quantum/html/directives/keyed.js"
...
```js
import {guard} from "@quantum/html/directives/guard.js"
```
...
```js
import {live} from "@quantum/html/directives/live.js"
```
...
```js
import {ref, createRef} from "@quantum/html/directives/ref.js"
```
...
```js
import {LitElement, html} from "@quantum/html/index"
import {ref} from "@quantum/html/directives/ref.js"
...
```js
import {templateContent} from "@quantum/html/directives/template-content.js"
```
...
**Описание**  
Директива `templateContent` позволяет клонировать содержимое элемента `<template>` и включать его в шаблон @quantum/html. Это полезно, когда нужно использовать статический HTML-контент, определенный вне компонента.
...
```js
import {unsafeHTML} from "@quantum/html/directives/unsafe-html.js"
```
...
```js
import {unsafeSVG} from "@quantum/html/directives/unsafe-svg.js"
```
...
```js
import {until} from "@quantum/html/directives/until.js"
```
...
```js
import {asyncAppend} from "@quantum/html/directives/async-append.js"
```
...
```js
import {asyncReplace} from "@quantum/html/directives/async-replace.js"
```
