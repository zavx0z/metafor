...
export class ComponentsPreviewSurface extends UiSurface {
  ...
  #eventCount = 0
  #fields: readonly FieldDefinition[] = createFieldPlaygroundDefinitions(
  ...
  #currentComponent(): ComponentName {
    if (this.#route.startsWith("field/")) return "Field"
  ...
  #toggleReference(): void {
    ...
    const value = current?.kind === "reference" ? current.value : null
    this.#updateField("reference", toggledReference(value))
  }
