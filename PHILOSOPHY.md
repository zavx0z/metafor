...
- dark matter — метафора скрытого структурного субстрата, который не наблюдается напрямую, но формирует организацию мира,
- dark energy — метафора внутренней тенденции скрытого мира к расширению через patches, snapshots и эволюцию схем.
...
Это область непроявленного и не сплющенного до канонической границы.

**Boundary** — предел, фиксация, достижение границы, flattening и приведение к определённости.
...
- snapshots,
- patches как линии эволюции модели,
- schema evolution.
...
- `Boundary × Gravity` — геометрия flattening и границы,
