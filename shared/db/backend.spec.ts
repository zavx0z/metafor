...
describe("shared db canonical relational data", () => {
  test("собирает только сущности и relation tables без persisted projection/index-space", () => {
    const fixture = createSharedDbFixture()
    const data = normalizeSharedDbData(assembleSharedDbData(fixture.root))
