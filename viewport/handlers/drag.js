import {MetaFor} from "../../metafor/index.js"
import {getUniqueSelector} from "../../pkg/core/utils/selectors.js"

MetaFor("viewport-drag-handler")
  ...
  .core(({update}) => ({
    ...
    viewport: document.querySelector("pkg-viewport")
  }))
  .actions({
  ...
  .create({
    state: "ОЖИДАНИЕ",
    onTransition: (oldState, newState, atom) => {
