/**
 * Типы входной matrix-структуры.
 *
 * @packageDocumentation
 *
 * @remarks
 * Поля описывают matrix-схему, которую затем читает слабый слой.
 */

import type { PreparedEntanglementProjection } from "@matrix/strong"

/**
 * Определение типа поля для matrix-схемы.
 *
 * @example
 * ```ts
...
export interface Data {
   ...
   *
   * Если не передана, Matrix не пытается самостоятельно выводить entanglement
