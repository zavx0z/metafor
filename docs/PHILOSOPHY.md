...
каждая проявленная область должна восстанавливаться из самодостаточной проекции,
не читая скрытые внутренности другого домена.
...
- `Force` переносит декларации, материализованные проекции и runtime-импульсы;
- `Matrix`, `Energy` и `Bulk` получают собственные самодостаточные проекции;
