...
Детальные разборы отдельных сил и topology-field канала вынесены в [Gravity](./proto/gravity.ru.md), [Electromagnetism](./proto/electromagnetism.ru.md), [Strong](./proto/strong.ru.md), [Weak](./proto/weak.ru.md) и [Higgs](./proto/higgs.ru.md).
...
- [Gravity](./proto/gravity.ru.md) — скрытая организация, адресуемость и внутренний геометрический протокол.
- [Electromagnetism](./proto/electromagnetism.ru.md) — наблюдаемое распространение, сигнал и перенос `State`.
- [Strong](./proto/strong.ru.md) — изменение значений ordinary `Field`, удержание формы и границы действия `Gluon`.
- [Higgs](./proto/higgs.ru.md) — topology-fields как Higgs fields, branch selection, branch multiplicity и `Higgs boson`.
