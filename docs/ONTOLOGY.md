...
Подробное протокольное описание силовых каналов задано в [корневом протоколе](./PROTOCOL.md), а глюонный октет и соответствия типам `Field` вынесены в [раздел Strong](./proto/strong.md).
...
Подробный протокольный слой этих соответствий задан в [корневом протоколе](./PROTOCOL.md), а детальные разборы сил вынесены в [Gravity](./proto/gravity.md), [Electromagnetism](./proto/electromagnetism.md), [Strong](./proto/strong.md) и [Weak](./proto/weak.md).
