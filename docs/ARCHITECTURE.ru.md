...
Подробный силовой разбор каналов задан в [корневом Force](./FORCE.ru.md), а различие обычных полей и полей topology вынесено в [раздел Strong](./proto/strong.ru.md) и [раздел Higgs](./proto/higgs.ru.md).
