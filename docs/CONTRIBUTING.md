...
- Сохраняйте текущую терминологию ветки: `Dark`, `Boundary`, `Energy`, `Bulk`, `Field`, `Brane`, Force-каналы и различие между обычными полями данных и полями topology.
...
- Рассматривайте `Dark`, `Boundary`, `Energy` и `Bulk` как изолированные доменные проекции, которые в зрелой форме будут связываться через Force-каналы.
- Учитывайте текущую техническую границу: `Dark` может работать с `Boundary`, а `Energy` и `Bulk` не читают `Boundary`/SQLite напрямую.
