 ...
 *
 * @property fragments {@link GravityStore.fragments|fragments} — загруженные фрагменты
 * @property nextPlacementSeq {@link GravityStore.nextPlacementSeq|nextPlacementSeq} — счётчик размещений
 * @property nextLinkSeq {@link GravityStore.nextLinkSeq|nextLinkSeq} — счётчик связей
 * @property nextReferenceSeq {@link GravityStore.nextReferenceSeq|nextReferenceSeq} — счётчик ссылок
 * @property rootOccurrenceSeq {@link GravityStore.rootOccurrenceSeq|rootOccurrenceSeq} — счётчик root
 *
 * @see {@link GravityStore} — тип состояния
