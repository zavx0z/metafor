/**
Bulk-owned parity projection из public Graph в Bulk calculation rows.

Production Bulk рождается из `BoundaryInitialProjection`; этот adapter остаётся
изолированным comparison path, а его hashed numeric IDs не являются Boundary
или public Graph identity.
...
/** Validation failure до входа Graph cut в изолированный Bulk adapter. */
...
/** Detached public document вместе с одной Bulk-local projection. */
...
/**
Валидирует и отделяет один Dark-owned Graph для isolated Bulk calculation.

Функция не владеет Store и не участвует в production Bulk birth или browser
updates.
*/
