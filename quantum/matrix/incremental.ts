 ...
 *
 * @see [Изменение Process аннулирует только затронутые выполнения](https://github.com/zavx0z/metafor/blob/main/quantum/matrix/incremental.spec.ts#L492-L606)
 * @see [CPU и WebGPU сохраняют одну структурную трассу](https://github.com/zavx0z/metafor/blob/main/quantum/matrix/incremental.spec.ts#L608-L642)
 *
...
import {STATE_NONE} from "@matrix/types/runtime"
import type {MatrixBraneRecord, MatrixData, MatrixStateRecord, MatrixTransitionRecord, MatrixValue} from "@matrix/types/store"
import type {WeakStructuralUpdate} from "@matrix/types/weak"
