 ...
 *
 * @see [Полный проход State → Process → commit](https://github.com/zavx0z/metafor/blob/main/matrix/matrix.spec.ts#L72-L233)
 * @see [Одинаковая причинная трасса CPU и WebGPU](https://github.com/zavx0z/metafor/blob/main/matrix/runtime.parity.spec.ts#L293-L313)
 *
