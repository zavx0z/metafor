 ...
 * слоем. Живой Force runtime хранит atom-centric projection отдельно.
 *
...
import type { MatrixStore, MatrixFieldValueRecord, MatrixFieldStorageLocation, MatrixValue, MatrixStateRecord } from "@matrix/types/store"
