...
заблокированные Branes, вводит неопределённые States в первый объявленный State
либо проверяет обычные Transitions. CPU является эталонным последовательным
исполнителем, WebGPU — параллельным; их наблюдаемая трасса обязана совпадать.
...
@see [Полный язык условий от Graph до шага Weak](https://github.com/zavx0z/metafor/blob/main/quantum/tests/graph/matrix-conditions.integration.spec.ts)
