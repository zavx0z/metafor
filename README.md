...
- **Процессы** — асинхронные действия с обработкой успеха/ошибок
...
Процессы — это асинхронные действия с обработкой успеха и ошибок.
...
Мы приветствуем вклад в развитие MetaFor! Пожалуйста, ознакомьтесь с нашим [руководством по вкладу](CONTRIBUTING.md).
