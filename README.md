...
> В процессе её осмысления была формализована **[Quantum Theory of Programming (qTp)](./doc/README.md)** — теоретический базис, определивший архитектурные и поведенческие принципы MetaFor.
...
[**qTp**](./doc/README.md) — это не внешний инструмент, а естественная формализация принципов, которые легли в основу MetaFor.  
...
Для получения подробной информации о возможностях, API и примерах использования MetaFor, см. [полную документацию](./doc/doc.md).

**Основные разделы документации:**

- [🚀 Основные возможности](./doc/doc.md#-основные-возможности)
- [🎯 Быстрый старт](./doc/doc.md#-быстрый-старт)
- [🏗️ Архитектура](./doc/doc.md#️-архитектура)
- [🔧 API Reference](./doc/doc.md#-api-reference)
- [🎨 Примеры](./doc/doc.md#-примеры)
- [🔍 Отладка](./doc/doc.md#-отладка)
