...
> В процессе её осмысления была формализована **[Quantum Theory of Programming (qTp)](README_qTp.md)** — теоретический базис, определивший архитектурные и поведенческие принципы MetaFor.
...
[**qTp**](./base/README.md) — это не внешний инструмент, а естественная формализация принципов, которые легли в основу MetaFor.  
...
Для получения подробной информации о возможностях, API и примерах использования MetaFor, см. [полную документацию](./schema/README.md).

**Основные разделы документации:**

- [🚀 Основные возможности](./schema/README.md#-основные-возможности)
- [🎯 Быстрый старт](./schema/README.md#-быстрый-старт)
- [🏗️ Архитектура](./schema/README.md#️-архитектура)
- [🔧 API Reference](./schema/README.md#-api-reference)
- [🎨 Примеры](./schema/README.md#-примеры)
- [🔍 Отладка](./schema/README.md#-отладка)
