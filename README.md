...
Внутри этой рамки текущий стартовый контур MetaFor разворачивается в пять
рабочих доменных проекций:
...
- `Matrix` как рантайм, где протекают переход, время и изменение
  состояния,
