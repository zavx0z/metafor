...
Для людей и внешних агентов, которые создают и развивают структуру Вселенной,
[рабочий гид обсуждения](agent-multiverse-discussion.md) сохраняет цель, ход
рассуждений, сравниваемые варианты и открытые вопросы всех подключённых
участников.
