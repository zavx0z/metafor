...
рантайм-слоями: получают данные в реальном времени через свой runtime-канал,
...
Канал во всех доменах называется `force`.
...
- `graviton`, `photon`, `gluon`, `higgs`, `w+`, `w-`, `z` — это `part`, а не путь и не уровень БД.
