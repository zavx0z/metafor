...
- [ ] Разобраться с багом TerminalPane: при прокрутке вверх во время поступления новых данных scrollback теряет визуальную целостность; строки/разделители смещаются и вывод выглядит разъехавшимся/перезаписанным.
