/**
 * `@boundary/weak/gpu/derived` выводит производные execution-формы из канонического Boundary store.
 *
...
/**
 * Выводит packed-данные Weak из канонического Boundary store.
 *
 ...
 */
export function deriveWeakData(store: BoundaryData): DerivedWeakData {
