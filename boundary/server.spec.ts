...
const createServerDomainStore = (): BoundaryStore => {
...
describe("boundary server domain smoke", () => {
  test("исполняет простой переход состояния в Boundary Weak runtime", async () => {
