/**
 * @boundary/matrix — Типы данных для GPU-эволюции суперпозиций.
 *
 * @packageDocumentation
 *
 * ## Назначение
 *
 * Определяет структуры данных для работы с GPU-матрицей:
 * - **FieldType** — типы полей для GPU
 * - **Field** — схема поля
 * - **Collapse** — переход между состояниями
 * - **Brane** — возмущение квантового поля (данные для GPU)
 * - **Data** — конфигурация для инициализации матрицы
 */
