...
Подтверждённые общесистемные расхождения Boundary по согласованности чтения,
атомарности результата, версии схемы и закрытию соединения находятся в
[`task/graph-monad-force-todo.md`](../task/graph-monad-force-todo.md). Здесь они
не дублируются.
