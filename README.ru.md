...
> В процессе её осмысления была формализована **[Quantum Theory of Programming (qTp)](actor/README.ru.md)** — теоретический базис, определивший архитектурные и поведенческие принципы MetaFor.
...
[**qTp**](actor/README.ru.md) — это не внешний инструмент, а естественная формализация принципов, которые легли в основу MetaFor.  
...
[qTp](actor/README.ru.md) определяет:
...
- [x] `@metafor/insect` - вывод изменений и инициаторов изменений в консоль браузера
- [ ] `@metafor/inspect` - остановка и замедление времени системы (debugger)
