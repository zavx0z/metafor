...
import type { ReactionsDeclaration, Reaction, ReactionsSchema, ReactionAction, ReactionFilterConditions } from "@metafor/dsl/types/reactions"
import { extractFields, normalizeFunctionString, updateAppendArg } from "./action"
import { Initiator, type Mass, type Self } from "@metafor/dsl/types/metafor"
