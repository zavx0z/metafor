...
import type { NodeLogical as TemplateNodeLogical } from "../template/node/logical.t"
import type { NodeMap as TemplateNodeMap } from "../template/node/map.t"
...
export type MatterAST = NodeType[]

export type MatterFieldDefinition = {
  type: string
}
