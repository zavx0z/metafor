/**
 * Типы входной energy-структуры.
 *
 * @packageDocumentation
 *
 * @remarks
 * Поля описывают energy-схему, которую затем читает слабый слой.
 */

import type { PreparedEntanglementProjection } from "@energy/strong"

/**
 * Определение типа поля для energy-схемы.
 *
 * @example
 * ```ts
...
export interface Data {
   ...
   *
   * Если не передана, Energy не пытается самостоятельно выводить entanglement
