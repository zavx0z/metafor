/**
 * @energy/weak/gpu/string-pack — материализация string atlas для GPU runtime.
 *
 * Модуль читает каноническую `stringTable` Energy и превращает её в
 ...
 *
 * Канонический `Energy store` хранит только `stringTable` и string id.
