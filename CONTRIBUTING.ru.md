...
- Сохраняйте текущую терминологию ветки `arch`: `Dark`, `Boundary`, `Bulk`, `Field`, `Brane`, протокольные каналы и различие между обычными полями данных и полями topology.
