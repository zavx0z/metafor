...
describe.todo("корневой > не в массиве > вложенность: нет > семантика: presence > не в условии > тип: по выражению > оператор: && > отрицание: нет > значение атрибута: одиночный", () => {
