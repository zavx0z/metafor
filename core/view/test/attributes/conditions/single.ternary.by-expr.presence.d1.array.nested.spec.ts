...
describe.todo("вложенный > в массиве > вложенность: одна > семантика: presence > не в условии > тип: по выражению > оператор: ?: > отрицание: нет > значение атрибута: одиночный", () => {
