...
describe.todo("вложенный > не в массиве > вложенность: нет > семантика: presence > не в условии > тип: по источнику > оператор: ?: > отрицание: да > значение атрибута: одиночный", () => {
