...
describe.todo("вложенный > не в массиве > вложенность: нет > семантика: scalar > не в условии > тип: по источнику > оператор: ?: > отрицание: нет > значение атрибута: одиночный", () => {
