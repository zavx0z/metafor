...
describe.todo("вложенный > не в массиве > вложенность: нет > семантика: scalar > не в условии > тип: по выражению > оператор: ?: > отрицание: нет > значение атрибута: одиночный", () => {
