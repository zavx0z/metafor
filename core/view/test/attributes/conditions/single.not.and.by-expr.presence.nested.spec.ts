...
describe.todo("вложенный > не в массиве > вложенность: нет > семантика: presence > не в условии > тип: по выражению > оператор: && > отрицание: да > значение атрибута: одиночный", () => {
