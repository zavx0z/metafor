...
1. привести доменные документы, публичные типы и TypeDoc к действующему коду;
1. после этого включить обязательные серверные проверки;
...
До отдельного решения владельца план не выдаёт агентной сессии как рабочую
возможность:
