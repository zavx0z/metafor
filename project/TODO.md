...
| ------ | ----------- | ----------- | -------------------------- |
| MF-104 | REVIEW      | нет         | [Открыть](tasks/MF-104.md) |

Все необходимые функциональные RPC реализованы; `MF-104` должна доказать их
совместную работу в одной воспроизводимой агентной сессии.

Текущая задача Codex: нет; `MF-104` ожидает закрывающей проверки.
