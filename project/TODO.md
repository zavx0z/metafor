...
Открытых задач нет. Полная сессия одного доверенного агента проверена.

Текущая задача Codex: нет; `AUD-004` ожидает закрывающей проверки.

## P1 — надёжность после функциональной полноты

| ID      | Состояние   | Зависимости | Карточка                    |
| ------- | ----------- | ----------- | --------------------------- |
| AUD-004 | REVIEW      | нет         | [Открыть](tasks/AUD-004.md) |
