...
вариантами` и `NODES-008 — Не оставлять пустой маршрутный резерв внутри
compound` проходят closing review изменений `@nodes/layout`.

Текущая задача Codex: `MF-424.2`.
