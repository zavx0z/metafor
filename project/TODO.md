...
`NODES-008 — Не оставлять пустой маршрутный резерв внутри compound` устраняет
лишний нижний резерв, когда фактические рёбра используют только боковые lanes.

Текущие задачи Codex: `MF-424.2` и `NODES-008`.
...
| NODES-008 | REVIEW      | нет       | [Открыть](tasks/NODES-008.md) |
