...
flowchart LR
    ...
    MF417["MF-417 · SVG-иконки Hamiltonian"]
    MF418["MF-418 · reload текущей версии"]
...
Текущая задача Codex: нет. Исправления `MF-417` и `MF-418` переданы в REVIEW.
...
| MF-417  | REVIEW      | нет            | [Открыть](tasks/MF-417.md)  |
| MF-418  | REVIEW      | нет            | [Открыть](tasks/MF-418.md)  |
