...
flowchart LR
    ...
    NODES012["NODES-012 · порядок SVG-слоёв вложенной сцены"]
...
[`NODES-012 — Исправить порядок SVG-слоёв вложенной сцены`](tasks/NODES-012.md):
линии внешних подписей должны уходить под листовые ноды, compound — под своих
потомков, а сокеты и внешние подписи остаются читаемыми сверху без изменения
layout result.
...
| NODES-012 | IN_PROGRESS | нет       | [Открыть](tasks/NODES-012.md) |
