...
локальный skill: краткий owner contract ссылается на глубокий TSDoc/TypeDoc, а
одинаковая ответственность browser/Bun сначала выражается общим interface.
Result `e3347ae67` прошёл Skill Creator validation и готов к review.
