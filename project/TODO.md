...
flowchart LR
    ...
    NODES013["NODES-013 · adaptive compound matrix"]
...
[`NODES-013 — Добавить adaptive compound matrix в playground`](tasks/NODES-013.md):
публичная adaptive policy получает видимые вложенные RIGHT/DOWN fixtures и
frozen proof без изменения общего solver.
...
| NODES-013 | IN_PROGRESS | нет       | [Открыть](tasks/NODES-013.md) |
