...
Текущая задача Codex: нет. NODES-002 исправлена после closing-review: фактический
Service Worker auto-reappear проверен в `RIGHT` и `DOWN`, final benchmark снят;
задача ожидает повторную независимую закрывающую проверку.
