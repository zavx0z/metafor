...
flowchart LR
    ...
    NODES004["NODES-004 · полная подсветка связей"]
    NODES005["NODES-005 · общий trunk связанных рёбер"]
...
rebirth и диагностических подключений. Следом зарегистрирована `MF-424.2`:
устойчивые цвета
...
Параллельные задачи NodeSystem/Layout: `NODES-004 — Подсвечивать все связи под
курсором` проходит closing review; `NODES-005 — Объединять связанные рёбра в
общий trunk` выполняется.

| ID     | Состояние   | Зависимости | Карточка                   |
| ------ | ----------- | ----------- | -------------------------- |
| MF-424 | IN_PROGRESS | нет         | [Открыть](tasks/MF-424.md) |
| NODES-004 | REVIEW      | нет      | [Открыть](tasks/NODES-004.md) |
