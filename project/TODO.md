...
flowchart LR
    ...
    DOC001["DOC-001 · правила документации"]
...
`DOC-001.2` завершён commit-ом `e02bb03de`, а `DOC-001.4` свёл package-wide
immutable artifacts commit-ом `396358708`. Задача находится в `REVIEW` и ждёт
