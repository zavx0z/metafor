...
Сохранять ноды, которые продолжаются в новой декларации` исправляет только
подавление source, который явно продолжается в successor declaration.

Текущие задачи Codex: NODES-008.5 — не удваивать правый боковой corridor в
`DOWN`; HAM-001.4 — сохранять ноды, которые продолжаются в новой декларации.
