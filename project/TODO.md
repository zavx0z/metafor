...
flowchart LR
    ...
    SYS001["SYS-001 · полный новый запуск"]
...
Текущая задача Codex: нет; `SYS-001` передана в REVIEW.

| ID      | Состояние   | Зависимости     | Карточка                    |
| ------- | ----------- | ---------------- | --------------------------- |
| SYS-001 | REVIEW      | нет              | [Открыть](tasks/SYS-001.md) |
| LAD-001 | READY       | нет              | [Открыть](tasks/LAD-001.md) |
| LAD-002 | READY       | нет              | [Открыть](tasks/LAD-002.md) |
