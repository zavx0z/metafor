...
| ID     | Состояние   | Зависимости       | Карточка                   |
| ------ | ----------- | ----------------- | -------------------------- |
| MF-202 | IN_PROGRESS | нет               | [Открыть](tasks/MF-202.md) |
| MF-203 | GATE        | нет               | [Открыть](tasks/MF-203.md) |
...
| ID     | Состояние | Зависимости    | Карточка                   |
| ------ | --------- | -------------- | -------------------------- |
| MF-300 | READY     | нет            | [Открыть](tasks/MF-300.md) |
| MF-301 | WAITING   | MF-300, MF-205 | [Открыть](tasks/MF-301.md) |
