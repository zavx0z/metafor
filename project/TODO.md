...
VectorInput/MatrixInput представлены отдельными stories. Текущий срез добавляет
новый public ReferenceInput; затем final matrix проверит `4016`, `4017`, `7901`
и эталон `4192` как один interaction contract.
