...
flowchart LR
    ...
    MF407["MF-407 · RPC одного агента"]
...
| ------ | ----------- | --------------------------------------------------------------- | -------------------------- |
| MF-407 | REVIEW      | нет                                                             | [Открыть](tasks/MF-407.md) |
| MF-103 | WAITING     | MF-407                                                          | [Открыть](tasks/MF-103.md) |
...
| MF-104 | WAITING     | MF-407, MF-103, MF-206, MF-408, MF-404, MF-409, MF-410          | [Открыть](tasks/MF-104.md) |

Полная сессия `MF-104` не начинается, пока каждый отсутствующий метод из
закрытого inventory `MF-407` не реализован и не проверен.
