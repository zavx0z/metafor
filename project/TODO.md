...
flowchart LR
    ...
    NODES011["NODES-011 · русский интерфейс playground"]
...
[`NODES-011 — Перевести стенд раскладки на русский язык`](tasks/NODES-011.md):
видимый chrome dev-only SVG playground переводится без изменения algorithms,
serialized graph data и package boundaries.
