...
не показал уже принятые линии. Текущий диагностический срез `HAM-001.3 —
Установить, почему действующие WebRTC-линии не попадают в кадр` локализует
первую расходящуюся границу без product patch.

Текущие задачи Codex: NODES-008.5 — не удваивать правый боковой corridor в
`DOWN`; HAM-001.3 — установить, почему действующие WebRTC-линии не попадают в
кадр.
