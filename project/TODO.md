...
flowchart LR
    ...
    ENGINE002["ENGINE-002 · компактные данные рендера"]
...
реализована, проверена в живом Hamiltonian и передана в `REVIEW`. Это
независимая техническая подзадача общего Engine в текущем визуальном срезе
`MF-424 — Визуально довести Hamiltonian вместе с владельцем` и `MF-425 —
Управлять одной Вселенной на одном устройстве`.
...
| ENGINE-002 | REVIEW      | нет            | [Открыть](tasks/ENGINE-002.md) |
