...
flowchart LR
    ...
    NODES012["NODES-012 · порядок SVG-слоёв выносок портов"]
...
[`NODES-012 — Исправить порядок SVG-слоёв выносок портов`](tasks/NODES-012.md):
линии внешних подписей должны уходить под листовые ноды, не меняя layout result,
а сокеты и внешние подписи остаются читаемыми сверху.
