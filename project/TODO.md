...
Текущая задача Codex: нет. NODES-001 и NODES-002 готовы одним причинно связанным
result bundle и ожидают независимой закрывающей проверки документации,
договоров, кода, tests и live evidence.
