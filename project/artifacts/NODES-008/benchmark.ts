...
const adapterSources = [
  "pkg/nodes/layout-engine.ts",
  "pkg/nodes/types/model.ts",
  "hamiltonian/browser/orchestration.ts",
  "hamiltonian/browser/orchestration/lifecycle-projection.ts",
  "hamiltonian/browser/orchestration/responsive-layout.ts",
]
const sourceHash = (paths: readonly string[]): string => sha256(paths.map((path) =>
...
const report = {
  ...
  layoutSourceSha256: sourceHash(layoutSources),
  adapterSourceSha256: sourceHash(adapterSources),
  environment: {
