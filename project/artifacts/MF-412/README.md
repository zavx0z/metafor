...
## Последующее перемещение кода

После фиксации evidence `MF-412` каталог стенда был механически
перенесён из `experiments/hamiltonian` в top-level `hamiltonian`. Все raw
файлы, контрольные суммы и их исторические path references ниже сохранены
без перезаписи.
