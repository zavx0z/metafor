...
Задача вынесена из независимого ревью
[`ENGINE-002 — Уменьшить передачу данных рендера без изменения картинки`](ENGINE-002.md).
Она не отменяет подтверждённое сокращение upload обычных объектов и не является
зависимостью ENGINE-002.
