...
Первый срез — [`MF-415`](tasks/MF-415.md). После его живой приёмки владелец
поэтапно выбирает детализацию topology и разрешённые операции управления.
