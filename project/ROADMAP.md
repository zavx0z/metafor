...
Model Service и Chat Send Tool. Runtime уже провёл завершённый предметный цикл
одного адресованного сообщения; текущий последний шаг — независимая E2E и
визуальная приёмка этого же цикла, а не самоизменение Лады:
