import type { NodeMap } from "./map.ts"
import type { NodeText } from "./text.ts"
import type { NodeElement } from "./element.ts"
import type { NodeCondition } from "./condition.ts"
import type { NodeLogical } from "./logical.ts"
import type { NodeMeta } from "./meta.ts"
import type { ValueType } from "../attribute/index.ts"
...
export interface PartsAttr extends Array<PartAttr> {}
